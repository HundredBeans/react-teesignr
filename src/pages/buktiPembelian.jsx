          ...
          <div className="col-md-8 col-sm-12 mx-auto">
            <div className="container py-3">
              ...
              >
                ...
                <div className="card-body text-center border-bottom py-auto">
                  <div className="row">
                ...
                <div className="container">
                  ...
                  <div className="container px-lg-5">
                    <div className="row py-3">
                      ...
                      <div className="col-lg-6 col-sm-6">
                        <span>: {this.props.detailPembayaran.id}</span>
                      </div>
                    </div>
                    <div className="row py-3 border-top">
                      ...
                      <div className="col-lg-6 col-sm-6">
                        <span>
                          : {this.props.detailPembayaran.total_belanja}
                        </span>
                      </div>
                    </div>
                    <div className="row py-3 border-top">
                      ...
                      <div className="col-lg-6 col-sm-6">
                        <span>
                          : {this.props.detailPembayaran.metode_pembayaran}
                        </span>
                      </div>
                    </div>
                    <div className="row py-3 border-top">
                      ...
                      <div className="col-lg-6 col-sm-6">
                        <span>
                          : {this.props.detailPembayaran.nama_penerima}
                        </span>
                      </div>
                    </div>
                    <div className="row py-3 border-top">
                      ...
                      <div className="col-lg-6 col-sm-6">
                        <span>: {this.props.detailPembayaran.no_telepon}</span>
                      </div>
                    </div>
                    <div className="row py-3 border-top">
                      <div className="col-lg-6 col-sm-6">
                      ...
                      <div className="col-lg-6 col-sm-6">
                        <span>
                          : {this.props.detailPembayaran.alamat_penerima}
                        </span>
                      </div>
                    </div>
                    <div className="row py-3 border-top">
